...
:END:
:LOGBOOK:
- Reference from [[id:org:6chkzp10fbj0][Refactor harmonize_replace]] on [2022-01-02 Sun 14:42]
:END:

#+BEGIN_SRC R :tangle R/harmonize_replace.r
...
#+BEGIN_SRC R :tangle inst/tinytest/test_harmonize_replace.r
  require(data.table)
...
#+BEGIN_SRC R :tangle R/harmonize_detect.r
...
#+BEGIN_SRC R :tangle inst/tinytest/test_harmonize_detect.r
  ## Tests for harmonize.detect

  ## testing x.rows
  expect_equal(
      harmonize_detect(x = data.frame(name =   c("MSlab Co."
                                           , "IBM Corp."
                                           , "Tilburg University")
                                , codes = c("",3,NA)
                                , lala = 1)
                 ...
                 , patterns_type = "ends"
                 , codes_name = "codes.new"
                 , patterns_codes_col = 1
                 , x_codes_merge = TRUE
                 , rows = c(FALSE, TRUE, FALSE))
  , data.table(name = c("MSlab Co.", "IBM Corp.", "Tilburg University"
  ), codes = c("", "3", NA), lala = c(1, 1, 1), codes.new = c(NA, 
  "Corp.", NA)))


  ## with codes.omitted.val = NA
  expect_equal(harmonize_detect(x = data.frame(name =   c("MSlab Co."
                                           , "IBM Corp."
                                           , "Tilburg University")
                                , codes = c("",3,NA)
                                , lala = 1)
                 , patterns = c("Co.", "Corp.", "MS")
                 , patterns_type = "ends"
                 , codes_omitted_val = "omitted"
                 , codes_name = "codes_new"
                 , patterns_codes_col = 1
                 , x_codes_merge = TRUE
                 , rows = c(FALSE, TRUE, FALSE))
  ...
  expect_equal(harmonize_detect(data.frame(name = c("MSlab Co."
                                     , "IBM Corp."
                                     , "Tilburg University")
                            , codes = c("",3,NA)
                            , lala = 1)
                 ...
                 , x_codes_merge = TRUE
                 , rows = c(FALSE, TRUE, FALSE))
   , structure(list(name = c("MSlab Co.", "IBM Corp.", "Tilburg University"
  ), codes = list("", c("Corp.", "3"), NA_character_), lala = c(1, 
  1, 1)), row.names = c(NA, -3L), class = c("data.table", "data.frame"
  )))

  ## same as about but for vector
  expect_equal(
  harmonize_detect(c("MSlab Co."
                   , "IBM Corp."
                   , "Tilburg University")
                 , c("Co.", "Corp.", "MS")
                 , patterns_type = "ends"
                 , codes = "ala"
                 , return_only_codes = FALSE)
  , structure(list(V1 = c("MSlab Co.", "IBM Corp.", "Tilburg University"
  ), V1coded = c("ala", "ala", NA)), row.names = c(NA, -3L), class = c("data.table", 
  "data.frame")))
  ...
  expect_equal(
      harmonize_detect(data.table(name = c("MSlab Co."
                                     , "IBM Corp."
                                     , "Tilburg University")
                            , codes = list(c("cool firm", "best firm ever")
                                         , "cool firm"
                                          ,"univer")
                            , lala = c(1,2,3))
                 , patterns = c("Co.", "Corp.", "MS")
                 ...
                 , rows = c(FALSE, TRUE, FALSE))
  , data.table(name = c("MSlab Co.", "IBM Corp.", "Tilburg University"
  ), codes = list(c("cool firm", "best firm ever"), c("corporation", 
                                                      "cool firm"), "univer"), lala = c(1, 2, 3)))


  ## TODO: test unmatch codes
#+END_SRC
