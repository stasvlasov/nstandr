...
#+BEGIN_SRC R :tangle inst/tinytest/test_harmonize_options.r

  harmonize_test <- \(data, ...) harmonize_options()
  
  ## should update defauls
  expect_equal(harmonize_test()$col, 1)
  expect_equal(harmonize_test(col = 2)$col, 2)
  
  harmonize_test <- \(data, col = 2, ...) harmonize_options()
  ...
  harmonize_test <- \(data, col = 123) harmonize_options()
  expect_equal(harmonize_test()$col, 1)
  harmonize_test <- \(col = 123, ...) harmonize_options()
  expect_equal(harmonize_test()$col, 1)
  
  
  ## should update defauls
  harmonize_test <- \(data, col = 123, ...) {
      harmonize_ <- \(data, ...) harmonize_options()
      harmonize_() 
  }
  ...
  ## should not update defauls
  harmonize_test <- \(data, col = 123, ...) {
      harmonize <- \(data, ...) harmonize_options()
      harmonize() 
  }
  expect_equal(harmonize_test()$col, 1)
#+END_SRC
