...
#+BEGIN_SRC R :tangle inst/tinytest/test_harmonize.r
  ...
  expect_equal(harmonize(as.numeric(1:10^2)
                       , procedures =
...
|  7 | Detecting Umlauts                        | 'magerman_detect_umlaut', codes_col_name = 'magerman_umlaut'                    |
...
|    |                                          |                                                                                 |
|    | *Legal forms*                            |                                                                                 |
| 15 | Detecting legal form                     | 'magerman_detect_legal_form', codes_col_name = 'legal_form'                     |
...
#+BEGIN_SRC R :tangle inst/tinytest/test_harmonize_magerman.r
  ...
  ## works now but weird naming of append_copy
  expect_equal(data.table(name = c("MÄKARÖNI ETÖ FKÜSNÖ Ltd"
                                 , "MSLab CÖ. <a href=lsdldf> <br> <\\a>"
                                 , "MSLab Co."
                                 , "MSLaeb Comp."
               ...
               harmonize_magerman(nrows_min_to_show_progress = 50
                                , show_progress = TRUE
                                , append_copy_before_common_words_removal = TRUE
                                , detect_legal_form = FALSE)
             , data.table(name = c("MAEKAEROENIETOEFKUESNOE"
                                 , "MSLAEBAEHREFLSDLDFAE"
                                 , "MSLAB"
